#!/bin/bash
sudo pacman -Syu 
sudo pacman -S htop bashtop neofetch vlc ffmpeg rust  zsh packagekit-qt5 latte-dock gimp zenity gvfs-mtp nvidia nvidia-utils nvidia-settings linux-headers xorg-xrandr repo
